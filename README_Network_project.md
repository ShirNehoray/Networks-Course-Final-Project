## Overview
This repository contains the code and analysis for the final project in networks in biology and ecology course. This project examining the use of cross-network validation for evaluating interaction link prediction accuracy in ecological networks.
